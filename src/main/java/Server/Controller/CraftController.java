...
public class CraftController {
            ...
            public void run() {
                ...
                for(Craft c : crafts) {
                    ...
                    if(c.getRemainingTime() <= 0) {
                        ...
                        Server.getInstance().getDataBase().addPlayerObjects(c.getUsername(), finalProduct.getRessource().ordinal(), finalProduct.getQuantity());
                        toRemove.add(c);
                    }
                }
    ...
    public boolean tryCraft(String username, int recipeIndex) {
        // tests
