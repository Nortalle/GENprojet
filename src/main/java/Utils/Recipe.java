...
public class Recipe {
    ...
    Recipe(String n,ResourceAmount fp, int time){
        name = Ressource.RessourceToString(fp.getRessource()) + " x" + fp.getQuantity();
        cost = new ArrayList<>();
        finalProduct = fp;
        productionTime = time;
        allRecipes.add(this);
    ...
    static {
        CARDBOARD_RCPT = new Recipe("Cardboard 2x", new ResourceAmount(Ressource.Type.CARDBOARD,2), 8);
        CARDBOARD_RCPT.addCost(new ResourceAmount(Ressource.Type.PAPER_PASTE, 1));
    }

    static Recipe CARDBOARD_BOX_RCPT;
    static {
        CARDBOARD_BOX_RCPT = new Recipe("Cardboard Box 8x", new ResourceAmount(Ressource.Type.CARDBOARD_BOX,8), 18);
    ...
    static {
        COPPER_CABLE_RCPT = new Recipe("Copper Cables 3x", new ResourceAmount(Ressource.Type.COPPER_CABLE,3), 5);
    ...
    static {
        GOLD_SHEET_RCPT = new Recipe("Gold Sheet 2x", new ResourceAmount(Ressource.Type.GOLD_SHEET,2), 10);
        GOLD_SHEET_RCPT.addCost(new ResourceAmount(Ressource.Type.GOLD_INGOT, 1));
    }

    static Recipe INSULATED_CABLE_RCPT;
    static {
        INSULATED_CABLE_RCPT = new Recipe("Insulated Cables 9x", new ResourceAmount(Ressource.Type.INSULATED_CABLE,9), 18);
    ...
    static {
        NAILS_RCPT = new Recipe("Nail Boxes 5x", new ResourceAmount(Ressource.Type.NAILS,5), 5);
    ...
    static {
        NYLON_FIBER_RCPT = new Recipe("Nylon Fiber 12x", new ResourceAmount(Ressource.Type.NYLON_FIBER,12), 12);
    ...
    static {
        PAPER_PASTE_RCPT = new Recipe("Paper Paste", new ResourceAmount(Ressource.Type.PAPER_PASTE,1), 10);
    ...
    static Recipe PETROL_BARREL_RCPT;
    static {
        PETROL_BARREL_RCPT = new Recipe("Petrol Barrel 5x", new ResourceAmount(Ressource.Type.PETROL_BARREL,5), 5);
        PETROL_BARREL_RCPT.addCost(new ResourceAmount(Ressource.Type.CRUDE_OIL, 50));
        PETROL_BARREL_RCPT.addCost(new ResourceAmount(Ressource.Type.WATER, 10));
        PETROL_BARREL_RCPT.addCost(new ResourceAmount(Ressource.Type.WOOD_BARREL, 1));
    }
    ...
    static {
        ...
        PLASTIC_RCPT.addCost(new ResourceAmount(Ressource.Type.PETROL_BARREL, 1));
    }

    static Recipe PLASTIC_SHEET_RCPT;
    static {
        PLASTIC_SHEET_RCPT = new Recipe("Plastic Sheet 3x", new ResourceAmount(Ressource.Type.PLASTIC_SHEET,3), 5);
    ...
    static {
        ...
        PUMP_T1_RCPT.addCost(new ResourceAmount(Ressource.Type.RIVET, 2));
        PUMP_T1_RCPT.addCost(new ResourceAmount(Ressource.Type.NYLON_ROPE, 1));
    }

    static Recipe RIVET_RCPT;
    static {
        RIVET_RCPT = new Recipe("Rivet Box 5x", new ResourceAmount(Ressource.Type.RIVET,5), 5);
    ...
    static {
        ...
        WOOD_BARREL_RCPT.addCost(new ResourceAmount(Ressource.Type.NAILS, 2));
    }

    static Recipe WOOD_CHIPS_RCPT;
    static {
        WOOD_CHIPS_RCPT = new Recipe("Wood Chips 10x", new ResourceAmount(Ressource.Type.WOOD_CHIPS,10), 5);
    ...
    static {
        ...
        WOODEN_CRATE_RCPT.addCost(new ResourceAmount(Ressource.Type.NAILS, 2));
    }

    static Recipe WOOD_STRIPS_RCPT;
    static {
        WOOD_STRIPS_RCPT = new Recipe("Wood Strips 2x", new ResourceAmount(Ressource.Type.WOOD_STRIP,2), 5);
